...
void setup()
{
  ...
  xTaskCreatePinnedToCore(sensor_task, "Sensor Read", SENSOR_TASK_STACK, NULL, SENSOR_TASK_PRIO, NULL, 1);
  xTaskCreatePinnedToCore(relay_task, "Relay Control", RELAY_TASK_STACK, NULL, RELAY_TASK_PRIO, NULL, 0);
  xTaskCreatePinnedToCore(tinyml_task, "TinyML Inference", TINYML_TASK_STACK, NULL, TINYML_TASK_PRIO, NULL, 0);
